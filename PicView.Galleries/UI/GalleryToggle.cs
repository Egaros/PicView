...
namespace PicView
{
    public static class GalleryToggle
    {
        #region Toggle 

        public static void Toggle(bool change = false)
        {
            if (Pics.Count < 1)
            {
                return;
        ...
        public static async void OpenContainedGallery()
        {
            if (Pics.Count < 1)
            {
                return;
        ...
        public static async void OpenFullscreenGallery()
        {
            if (Pics.Count < 1)
            {
                return;
        ...
        public static void CloseContainedGallery()
        {
            IsOpen = false;
        ...
        public static void CloseFullscreenGallery()
        {
            Properties.Settings.Default.PicGallery = 1;
            IsOpen = false;
            fakeWindow.Hide();
        ...
        public static void ChangeToPicGalleryOne()
        {
            Properties.Settings.Default.PicGallery = 1;
            LoadLayout();
        ...
        public static void ChangeToPicGalleryTwo()
        {
            Properties.Settings.Default.PicGallery = 2;
            LoadLayout();
