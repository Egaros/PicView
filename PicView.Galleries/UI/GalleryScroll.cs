...
namespace PicView
{
    ...
    public static class GalleryScroll
    {
        ...
        public static void ScrollTo(object sender, MouseWheelEventArgs e)
        {
        ...
        public static void ScrollTo(bool next, bool end = false, bool speedUp = false)
        {
            if (end)
            {
                if (next)
