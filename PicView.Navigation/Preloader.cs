...
namespace PicView.Navigation
{
    ...
    public static class Preloader
    {
        ...
        public static async Task<bool> Add(string file)
        {
        ...
        public static async Task<bool> Add(int i)
        {
            if (i >= Pics.Count || i < 0)
            {
                return false;
...
//#endif
        ...
        public static void Add(BitmapSource bmp, string key)
        {
        ...
        public static async void PreloaderFix(string file)
        {
            if (!Contains(file))
            {
                PreloadCount = 4;
        ...
        public static Task PreLoad(int index)
        {
#if DEBUG
