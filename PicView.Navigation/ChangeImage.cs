...
namespace PicView.Navigation
{
    public static class ChangeImage
    {
        ...
        public static async void Pic(string path)
        {
            // Set Loading
        ...
        public static async void Pic(int x)
        {
            BitmapSource pic;
        ...
        public static void Pic(BitmapSource pic, string imageName)
        {
        ...
        /// <param name="pic"></param>
        /// <param name="imageName"></param>
        public static async void Pic64(string base64string)
        {
        ...
        public static void PicFolder(string folder)
        {
            ChangeFolder(true);
        ...
        public static void Pic(bool next = true, bool end = false)
        {
        ...
        public static void PicButton(bool arrow , bool right)
        {
            if (arrow)
            {
                if (!CanNavigate)
        ...
        public static void FastPic(bool forwards)
        {
        ...
        /// </summary>
        public static void FastPicUpdate()
        {
            if (!FastPicRunning)
            {
                return;
