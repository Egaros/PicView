...
namespace PicView.Navigation
{
    public static class Error_Handling
    {
        ...
        public static async Task<BitmapSource> PicErrorFix(int x)
        {
        ...
        /// </summary>
        public static void ChangeFolder(bool backup = false)
        {
            if (backup)
            {
        ...
        /// </summary>
        public static void Reload(bool fromBackup = false)
        {
        ...
        /// </summary>
        public static void DisplayBrokenImage()
        {
            mainWindow.img.Source = null;
