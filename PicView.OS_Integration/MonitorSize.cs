...
namespace PicView.OS_Integration
{
    ...
    /// </summary>
    public readonly struct MonitorSize
    {
        /// <summary>
        /// Used to get and set monitor size
        /// </summary>
        public static MonitorSize MonitorInfo { get; set; }


        public readonly int Width { get; }
        public readonly int Height { get; }

        public readonly double DpiScaling { get; }

        public readonly Rect WorkArea { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public static MonitorSize GetMonitorSize()
        {
