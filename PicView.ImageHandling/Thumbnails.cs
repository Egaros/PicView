...
namespace PicView
{
    public static class Thumbnails
    {
        ...
        /// <returns></returns>
        public static BitmapSource GetThumb(int x, bool startup)
        {
            if (!startup)
            {
                return GetThumb(x);
        ...
        /// </summary>
        /// <returns></returns>
        public static BitmapSource GetThumb(int x)
        {
        ...
        public static BitmapSource GetBitmapSourceThumb(string path)
        {
        ...
        /// <returns></returns>
        public static BitmapSource GetMagickImageThumb(string file, byte quality = 100, short size = 256)
        {
            BitmapSource pic;
        ...
        /// <returns></returns>
        public static BitmapSource GetWindowsThumbnail(string path, bool extralarge = false)
        {
            if (!File.Exists(path))
            {
                return null;
