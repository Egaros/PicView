...
namespace PicView
{
    public static class SaveImages
    {
        ...
        /// <returns></returns>
        public static bool TrySaveImage(int rotate, bool flipped, string path, string destination)
        {
            try
            {
        ...
        public static bool TrySaveImage(int rotate, bool flipped, BitmapSource bitmapSource, string destination)
        {
            try
            {
                using var SaveImage = new MagickImage();
        ...
        /// /// <param name="destination">Where to save image to</param>
        /// <returns></returns>
        public static bool TrySaveImage(Int32Rect rect, string path, string destination)
        {
            try
            {
                using var SaveImage = new MagickImage
        ...
        public static bool TrySaveImage(Int32Rect rect, BitmapSource bitmapSource, string destination)
        {
            try
            {
                using var SaveImage = new MagickImage
        ...
        public static void ResizeImageToFile(string file, int NewWidth, int NewHeight)
        {
            try
            {
