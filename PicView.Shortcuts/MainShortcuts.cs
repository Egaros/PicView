...
namespace PicView.Shortcuts
{
    ...
    {
        public static void MainWindow_KeysDown(object sender, KeyEventArgs e)
        {
        ...
        public static void MainWindow_KeysUp(object sender, KeyEventArgs e)
        {
            // Don't allow keys when typing in text
            if (mainWindow.Bar.IsKeyboardFocusWithin) { return; }
        ...
        public static void MainWindow_MouseDown(object sender, MouseButtonEventArgs e)
        {
