...
namespace PicView.FileHandling
{
    ...
    public static class RecentFiles
    {
        ...
        /// </summary>
        public static Queue<string> MRUlist;
        ...
        public static bool IsZipped { get; set; }
        ...
        public static void SetZipped(string zipfile, bool isZipped = true)
        {
        ...
        public static void Recentcm_MouseEnter(object sender)
        {
